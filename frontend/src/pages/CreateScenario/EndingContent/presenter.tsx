...
const EndingContentPresenter = ({targetCharacter}: Props) => {
  const {
    otherCharacters,
    criminal,
    editingCharacter,
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        onPress={() => {
                          ...
                          console.log(
                            'targetEnding:',
                            targetEnding.storySerifLine,
                          );
                          const bufStorySerifLine =
                            targetEnding.storySerifLine.filter(
